...
const DashboardHeader: React.FC<DashboardHeaderProps> = ({
  ...
  return (
    <header className="bg-white py-3 px-6 md:px-12 shadow-sm sticky top-0 z-40">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center space-x-8">
          ...
          <Link href="/my-children" className="text-gray-700 font-medium hover:text-indigo-600 transition-colors">
            My Children
          </Link>
        ...
        <div className="md:hidden mt-3 py-3 px-4 bg-white border-t border-gray-100">
          ...
          <nav className="flex flex-col space-y-3">
            ...
            <div className="pt-2 border-t border-gray-100 flex flex-col space-y-3">
              ...
              <Link 
                href="/logout" 
                className="text-red-600 font-medium py-2 px-3 rounded-lg hover:bg-red-50"
                onClick={() => setIsMenuOpen(false)}
              >
                Logout
              </Link>
